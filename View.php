...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \QuantaQuirk\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \QuantaQuirk\View\Factory  $factory
     * @param  \QuantaQuirk\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \QuantaQuirk\Contracts\Support\MessageProvider|array  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @return \QuantaQuirk\View\Factory
     */
